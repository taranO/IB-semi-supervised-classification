...
parser.add_argument("--checkpoint_dir", default="Dcc_Da_Dc/Dcc_Dz_Dc_%sbn_%s_alpha_a_%s_alpha_c_%s_%snoise_%0.2f_run_%s", type=str, help="Dir where to same models")
